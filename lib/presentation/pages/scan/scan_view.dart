          ...
          children: [
            ...
            if (hasCapture)
              Container(
                ...
                child: const Center(
                  child: Icon(Icons.check_circle_rounded, color: Color(0xFF5EE0A0), size: 72),
                ),
              ),
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(colors: [
              Colors.transparent,
              const Color(0xFF6AAEE8).withValues(alpha: 0.8),
              const Color(0xFF6AAEE8),
              const Color(0xFF6AAEE8).withValues(alpha: 0.8),
              Colors.transparent,
            ]),
            boxShadow: [
              BoxShadow(
                color: const Color(0xFF6AAEE8).withValues(alpha: 0.5),
                blurRadius: 8,
                spreadRadius: 2,
              ),
            ],
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      ...
      return GestureDetector(
        onTap: isCaptured ? controller.onRetake : controller.onCapture,
        child: Container(
          height: 56,
          width: double.infinity,
          decoration: BoxDecoration(
            gradient: const LinearGradient(colors: [Color(0xFF7AAEDE), Color(0xFF4A90D9)]),
            ...
            child: isLoading
                ...
                : Row(
                    ...
                    children: [
                      ...
                      Text(
                        isCaptured ? 'Ambil Ulang' : 'Capture',
